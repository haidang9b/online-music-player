...
public class HomeFragment extends Fragment {
    ...
    private void initsData() {
        listButtons.add(new ListButton(1, "Bài hát"));
        listButtons.add(new ListButton(2, "Ca sĩ"));
        listButtons.add(new ListButton(3, "Album"));
        listButtons.add(new ListButton(4, "Bảng xếp hạng"));
        listButtons.add(new ListButton(5, "Hôm nay nghe gì?"));
        listButtons.add(new ListButton(6, "Trình phát nhạc"));
